...
# Use a for-in loop to iterate over the `numbers` array, and if a number is even, 
# add  it to the `even_numbers` array.
...
# Problem 12
# Research to find the Python method that allows you to add an element to the end of the
#  array (similar to push() in JavaScript), then add a name to the end of the `friends` array.
friends.append("Gary")
...
print(friends)
print("There can only be one G Friend here")